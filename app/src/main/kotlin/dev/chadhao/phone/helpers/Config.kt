    ...
    var quickAnswers: ArrayList<String>
        get(): ArrayList<String> {
            val defaultList = arrayListOf(
                ContextCompat.getString(context, dev.chadhao.phone.R.string.message_call_later),
                ContextCompat.getString(context, dev.chadhao.phone.R.string.message_on_my_way),
                ContextCompat.getString(context, dev.chadhao.phone.R.string.message_cant_talk_right_now)
            )
