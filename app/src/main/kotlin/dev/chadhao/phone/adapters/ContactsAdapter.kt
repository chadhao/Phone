...
import dev.chadhao.phone.databinding.ItemContactWithNumberGridSwipeBinding
import dev.chadhao.phone.databinding.ItemContactWithNumberInfoSwipeBinding
...
//            }
//        }
        // Fix: NullPointerException: Missing required view with ID: dev.chadhao.phone:id/item_contact_holder
        if (!activity.isDestroyed && !activity.isFinishing) {
